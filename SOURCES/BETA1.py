...
# --------------------------------------------------
# FUNCTIE PENTRU PROCESAREA PACHETULUI URMĂRIT
# --------------------------------------------------
def process_tracked_package(tracked_pkg):
    # Preia poziția pachetului urmărit
    x, y = tracked_pkg["position"]
    # Apelează funcția care generează comenzile de mișcare
    ...
    print("Move Commands:")
    # Parcurge comenzile și le afișează în seturi de câte 4 valori
    print(cmds)
    print(comanda)
    
    #COMANDA ce misca masina
...
def main():
    ...
    while True:
                ...
                if not tracked_package["letters"]:
                    ...
                    if tracked_package is not None:
                        if "miss_detections" not in tracked_package:
                            tracked_package["miss_detections"] = 0  # Inițializare dacă nu există
        ...
        if tracked_package is not None:
            ...
            # Se preia poziția pachetului urmărit și se generează comenzile de mișcare
