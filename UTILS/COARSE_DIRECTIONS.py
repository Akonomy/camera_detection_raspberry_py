...
FORWARD_BACKWARD_TABLE = {
    # speed: { ticks: distanta }
    110: {1: 3.5,  2: 5.5,  3: 10.0, 4: 13.0},
    120: {1: 3.3,  2: 5.0,  3: 9.0,  4: 11.0},
    130: {1: 3.0,  2: 4.5,  3: 8.0,  4: 11.5},
    140: {1: 2.0,  2: 4.0,  3: 7.5,  4: 10.0},
    150: {1: 1.8,  2: 3.5,  3: 7.0,  4: 9.5},
}
